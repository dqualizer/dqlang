...
public class Activity {
    ...
    public Activity(String dqId, String name, String operationId, Activity.Type type, Set<String> parameter, Endpoint endpoint) {
        super();
        this.dqId = dqId;
        this.name = name;
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return (((((((this.endpoint == rhs.endpoint)||((this.endpoint!= null)&&this.endpoint.equals(rhs.endpoint)))&&((this.dqId == rhs.dqId)||((this.dqId!= null)&&this.dqId.equals(rhs.dqId))))&&((this.parameter == rhs.parameter)||((this.parameter!= null)&&this.parameter.equals(rhs.parameter))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.operationId == rhs.operationId)||((this.operationId!= null)&&this.operationId.equals(rhs.operationId))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))));
    }
