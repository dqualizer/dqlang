...
public class K6Constants {
    ...
    public String toString() {
        ...
        sb.append(K6Constants.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("accuracy");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.accuracy == rhs.accuracy)||((this.accuracy!= null)&&this.accuracy.equals(rhs.accuracy)))&&((this.loadProfile == rhs.loadProfile)||((this.loadProfile!= null)&&this.loadProfile.equals(rhs.loadProfile))))&&((this.responseTime == rhs.responseTime)||((this.responseTime!= null)&&this.responseTime.equals(rhs.responseTime))));
    }
