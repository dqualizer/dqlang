...
public class ConstantLoad {
    ...
    public String toString() {
        ...
        sb.append(ConstantLoad.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("low");
        sb.append('=');
        sb.append(this.low);
        sb.append(',');
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.high == rhs.high)&&(this.minDuration == rhs.minDuration))&&(this.low == rhs.low))&&(this.medium == rhs.medium))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&(this.maxDuration == rhs.maxDuration));
    }
