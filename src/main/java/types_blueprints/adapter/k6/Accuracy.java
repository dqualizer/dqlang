...
public class Accuracy {
    ...
    public String toString() {
        ...
        sb.append(Accuracy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        return (((this.repetition == rhs.repetition)||((this.repetition!= null)&&this.repetition.equals(rhs.repetition)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
