...
public class LoadProfile {
    ...
    public String toString() {
        ...
        sb.append(LoadProfile.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("loadPeak");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.loadPeak == rhs.loadPeak)||((this.loadPeak!= null)&&this.loadPeak.equals(rhs.loadPeak)))&&((this.loadIncrease == rhs.loadIncrease)||((this.loadIncrease!= null)&&this.loadIncrease.equals(rhs.loadIncrease))))&&((this.constantLoad == rhs.constantLoad)||((this.constantLoad!= null)&&this.constantLoad.equals(rhs.constantLoad))));
    }
