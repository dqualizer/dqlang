...
public class LoadPeak {
    ...
    public LoadPeak(int high, int veryHigh, int extremelyHigh, String slow, String fast, String veryFast, String coolDownDuration) {
        super();
        this.high = high;
    ...
    public String toString() {
        ...
        sb.append(LoadPeak.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("high");
        sb.append('=');
        sb.append(this.high);
        sb.append(',');
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.veryFast == rhs.veryFast)||((this.veryFast!= null)&&this.veryFast.equals(rhs.veryFast)))&&(this.high == rhs.high))&&(this.extremelyHigh == rhs.extremelyHigh))&&((this.fast == rhs.fast)||((this.fast!= null)&&this.fast.equals(rhs.fast))))&&((this.slow == rhs.slow)||((this.slow!= null)&&this.slow.equals(rhs.slow))))&&(this.veryHigh == rhs.veryHigh))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.coolDownDuration == rhs.coolDownDuration)||((this.coolDownDuration!= null)&&this.coolDownDuration.equals(rhs.coolDownDuration))));
    }
