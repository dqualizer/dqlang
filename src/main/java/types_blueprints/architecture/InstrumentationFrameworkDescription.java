...
public class InstrumentationFrameworkDescription {
    ...
    public InstrumentationFrameworkDescription(java.lang.String name, boolean existing, boolean enabledMetrics, boolean enabledTraces, boolean enabledLogs, Map<String, String> frameworkOptions) {
        super();
        this.name = name;
