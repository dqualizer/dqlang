...
package dqualizer.dqlang.types.architecture;
...
public class Instrument {
    ...
    public Instrument(List<String> metricLabels, String metricName, String instrumentName, Instrument.InstrumentType instrumentType, InstrumentationLocation location) {
        super();
    ...
    public enum InstrumentType {
        ...
        private final static Map<String, Instrument.InstrumentType> CONSTANTS = new HashMap<String, Instrument.InstrumentType>();

        static {
            for (Instrument.InstrumentType c: values()) {
        ...
        @JsonCreator
        public static Instrument.InstrumentType fromValue(String value) {
            Instrument.InstrumentType constant = CONSTANTS.get(value);
            if (constant == null) {
