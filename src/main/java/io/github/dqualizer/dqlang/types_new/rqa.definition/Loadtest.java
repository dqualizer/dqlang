...
public class Loadtest {
    ...
    /**
     * An identifier for a Loadtest. (Can be null)
     */
    ...
    /**
     * References to data sources for parametrization (Required)
     */
    ...
    /**
     * @param parametrization References to data sources for parametrization.
     * @param name            An identifier for a Loadtest.
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.artifact == rhs.artifact) || ((this.artifact != null) && this.artifact.equals(rhs.artifact))) && ((this.responseMeasure == rhs.responseMeasure) || ((this.responseMeasure != null) && this.responseMeasure.equals(
                rhs.responseMeasure)))) && ((this.resultMetrics == rhs.resultMetrics) || ((this.resultMetrics != null) && this.resultMetrics.equals(
                rhs.resultMetrics)))) && ((this.parametrization == rhs.parametrization) || ((this.parametrization != null) && this.parametrization.equals(
                rhs.parametrization)))) && ((this.stimulus == rhs.stimulus) || ((this.stimulus != null) && this.stimulus.equals(
                rhs.stimulus)))) && ((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))) && ((this.description == rhs.description) || ((this.description != null) && this.description.equals(
                rhs.description))));
    }
