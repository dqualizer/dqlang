...
public class RuntimeQualityAnalysis {
    ...
    /**
     * Configurations for specified monitoring (Required)
     */
    ...
    /**
     * Configurations for specified resilience tests (Required)
     */
    ...
    /**
     * Configurations for specified load tests (Required)
     */
    ...
    /**
     * @param monitoring Configurations for specified monitoring.
     * @param resilience Configurations for specified resilience tests.
     * @param loadtests  Configurations for specified load tests.
     */
    ...
    public String toString() {
        ...
        sb.append(RuntimeQualityAnalysis.class.getName())
          .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.monitoring == rhs.monitoring) || ((this.monitoring != null) && this.monitoring.equals(rhs.monitoring))) && ((this.resilience == rhs.resilience) || ((this.resilience != null) && this.resilience.equals(
                rhs.resilience)))) && ((this.loadtests == rhs.loadtests) || ((this.loadtests != null) && this.loadtests.equals(
                rhs.loadtests))));
    }
