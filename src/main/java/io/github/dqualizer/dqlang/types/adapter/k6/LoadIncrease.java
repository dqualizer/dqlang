...
public class LoadIncrease {
    ...
    public String toString() {
        ...
        sb.append(LoadIncrease.class.getName())
          .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.linear == rhs.linear) && (this.cubic == rhs.cubic)) && (this.quadratic == rhs.quadratic)) && ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null) && this.additionalProperties.equals(
                rhs.additionalProperties)))) && (this.startTarget == rhs.startTarget)) && (this.endTarget == rhs.endTarget)) && ((this.stageDuration == rhs.stageDuration) || ((this.stageDuration != null) && this.stageDuration.equals(
                rhs.stageDuration))));
    }
