...
public class APISchema {
    ...
    /**
     * Version of this schema representation (Required)
     */
    ...
    public int version;
    /**
     * The name of the Bounded Context to which this schema belongs (Required)
     */
    ...
    /**
     * Used API Schema of the Bounded Context (Required)
     */
    @JsonProperty("api")
    ...
    public String api;
    /**
     * Collection of different URls of this Bounded Context (Required)
     */
    ...
    /**
     * Information about all endpoints of this Bounded Context (Required)
     */
    @JsonProperty("field")
    @JsonDeserialize(as = java.util.LinkedHashSet.class)
    ...
    /**
     * Data schemas of all used data types in this API schema (Required)
     */
    ...
    /**
     * @param serverInfo  Collection of different URls of this Bounded Context.
     * @param field       Information about all endpoints of this Bounded Context.
     * @param dataSchemas Data schemas of all used data types in this API schema.
     * @param context     The name of the Bounded Context to which this schema belongs.
     * @param api         Used API Schema of the Bounded Context.
     * @param version     Version of this schema representation.
     */
    ...
    public String toString() {
        ...
        sb.append(APISchema.class.getName())
          .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.serverInfo == rhs.serverInfo) || ((this.serverInfo != null) && this.serverInfo.equals(rhs.serverInfo))) && ((this.field == rhs.field) || ((this.field != null) && this.field.equals(
                rhs.field)))) && ((this.dataSchemas == rhs.dataSchemas) || ((this.dataSchemas != null) && this.dataSchemas.equals(
                rhs.dataSchemas)))) && ((this.context == rhs.context) || ((this.context != null) && this.context.equals(
                rhs.context)))) && ((this.api == rhs.api) || ((this.api != null) && this.api.equals(rhs.api)))) && ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null) && this.additionalProperties.equals(
                rhs.additionalProperties)))) && (this.version == rhs.version));
    }
