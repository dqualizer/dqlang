...
public class RuntimeQualityAnalysisDefinition {
    ...
    /**
     * A unique identifier for the rqa definition (Can be null)
     */
    ...
    public int id;
    /**
     * Every Rqa-Definition has a unique name (Can be null)
     */
    ...
    public String name;
    /**
     * Version of this modeling representation (Required)
     */
    ...
    public int version;
    /**
     * The name of the Bounded Context to which this modeling belongs (Required)
     */
     ...
     * @param name        Every Rqa-Definition has a unique name.
     * @param context     The name of the Bounded Context to which this modeling belongs.
     * @param id          A unique identifier for the rqa definition.
     * @param version     Version of this modeling representation.
     */
    ...
    public RuntimeQualityAnalysisDefinition(int id,
                                            String name,
                                            int version,
                                            String context,
                                            String environment,
    ...
    public String toString() {
        ...
        sb.append(RuntimeQualityAnalysisDefinition.class.getName())
          .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.runtimeQualityAnalysis == rhs.runtimeQualityAnalysis) || ((this.runtimeQualityAnalysis != null) && this.runtimeQualityAnalysis.equals(
                rhs.runtimeQualityAnalysis))) && ((this.environment == rhs.environment) || ((this.environment != null) && this.environment.equals(
                rhs.environment)))) && ((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))) && ((this.context == rhs.context) || ((this.context != null) && this.context.equals(
                rhs.context)))) && (this.id == rhs.id)) && (this.version == rhs.version));
    }
