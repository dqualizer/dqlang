...
import io.github.dqualizer.dqlang.types.architecture.SoftwareSystem;
...
public class DomainArchitectureMapping {
    ...
    /**
     * Version of this mapping representation (Required)
     */
    ...
    public int version;
    /**
     * The name of the Bounded Context to which this mapping belongs (Required)
     */
    ...
    /**
     * List of different hosts (Required)
     */
    ...
    /**
     * List of technical entities that represent Work Objects and Actors from Domain Stories (Required)
     */
    ...
    public SoftwareSystem system = null;
    ...
    /**
     * @param serverInfo List of different hosts.
     * @param objects    List of technical entities that represent Work Objects and Actors from Domain Stories.
     * @param context    The name of the Bounded Context to which this mapping belongs.
     * @param version    Version of this mapping representation.
     */
    ...
    public String toString() {
        ...
        sb.append(DomainArchitectureMapping.class.getName())
          .append('@')
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return (((((this.context == rhs.context) || ((this.context != null) && this.context.equals(rhs.context))) && ((this.serverInfo == rhs.serverInfo) || ((this.serverInfo != null) && this.serverInfo.equals(
                rhs.serverInfo)))) && (this.version == rhs.version)) && ((this.objects == rhs.objects) || ((this.objects != null) && this.objects.equals(
                rhs.objects))));
    }
