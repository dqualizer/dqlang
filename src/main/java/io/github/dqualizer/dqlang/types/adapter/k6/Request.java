...
public class Request {
    ...
    /**
     * Path of this endpoint (Required)
     */
    @JsonProperty("path")
    ...
    /**
     * Values that should be checked by k6 (Required)
     */
    @JsonProperty("checks")
    ...
    /**
     * @param path          Path of this endpoint.
     * @param pathVariables References to data sources that can be used for url parameters, like Ids, for this method.
     * @param checks        Values that should be checked by k6.
     * @param queryParams   References to data sources that can be used for url parameters for this method.
     * @param payload       References to data sources that can be used for payload bodies for this method.
     * @param type          Type of HTTP-method.
     * @param params        References to data sources that can be used for request parameters, like headers or cookies,
     *                      for this method.
     */
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.path == rhs.path) || ((this.path != null) && this.path.equals(rhs.path))) && ((this.pathVariables == rhs.pathVariables) || ((this.pathVariables != null) && this.pathVariables.equals(
                rhs.pathVariables)))) && ((this.checks == rhs.checks) || ((this.checks != null) && this.checks.equals(
                rhs.checks)))) && ((this.queryParams == rhs.queryParams) || ((this.queryParams != null) && this.queryParams.equals(
                rhs.queryParams)))) && ((this.payload == rhs.payload) || ((this.payload != null) && this.payload.equals(
                rhs.payload)))) && ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null) && this.additionalProperties.equals(
                rhs.additionalProperties)))) && ((this.type == rhs.type) || ((this.type != null) && this.type.equals(rhs.type)))) && ((this.params == rhs.params) || ((this.params != null) && this.params.equals(
                rhs.params))));
    }
