...
data class SoftwareSystem(
  ...
  /**
   * The runtime platforms that the various parts of the software system run on. An empty array
   * should indicate that the software system runs on a local runtime platform.
   */
