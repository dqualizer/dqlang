...
data class ServiceDescription(
  ...
  @JsonPropertyDescription("Route to access the service. e.g. ssh address, ") val uri: URI,
  ...
  @JsonPropertyDescription(
    "The controllers that this service provides. Legacy class to keep compatibilty to the first iteration of dqualizer.",
  )
